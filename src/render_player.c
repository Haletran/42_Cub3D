...
//        {
//            mlx->ray->y = (((int)mlx->player->y / 32) * 32) - 0.001;
...
//        {
//            mlx->ray->hx = (((int)mlx->player->x / 32) * 32) - 0.001;
...
//        i++;
//    } 
//	PA = abs((int)mlx->player->x - (int)mlx->ray->x) / cos(mlx->player->angle);
//	PB = abs((int)mlx->player->x - (int)mlx->ray->hx) / cos(mlx->player->angle);
//	if (PA > PB)
//	{
//		mlx->ray->x = mlx->ray->hx;
//		mlx->ray->y = mlx->ray->hy;
//	}
