...
/*   Updated: 2024/06/18 23:21:05 by baptiste         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int ft_error(int choice)
{
	...
	if (choice == ERROR_IMAGE)
		...
		ft_printf_fd(2, BOLDRED"[ ERROR ] : "RESET "Not enough arguments or too much\n");
		...
		ft_printf_fd(2, BOLDRED"[ ERROR ] : "RESET "Texture file not found\n");
	return (choice);
}
