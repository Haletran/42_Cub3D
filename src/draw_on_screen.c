...
/*   Updated: 2024/08/09 00:55:06 by bapt             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void draw_debug(t_mlx *mlx, t_xy *xy, t_wh *wh)
{
    ...
    mlx_string_put(mlx->mlx, mlx->win, xy->y + 10, xy->x + 140, 0x00FFFFFFFF, ft_strjoin("FOV = ", ft_itoa(FOV)));
    mlx_string_put(mlx->mlx, mlx->win, xy->y + 10, xy->x + 160, 0x00FFFFFFFF, ft_strjoin("NB rays = ", ft_itoa(RAYS)));
